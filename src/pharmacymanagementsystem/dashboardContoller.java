...
//    DATABASE TOOLS
    ...
    private String[] addMedicineListT = {"Cair", "Tablet", "Kapsul", "Oles", "Tetes"};
    ...
    public void defaultNav(){
        dashboard_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #c2ced0, #22bde4);");
    }
    ...
    public void switchForm(ActionEvent event){
        ...
        if(event.getSource() == dashboard_btn){
            ...
            addMed_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #c2ced0, #22bde4);");
            ...
            pruchase_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #c2ced0, #22bde4);");
            dashboard_btn.setStyle("-fx-background-color:transparent");
            addMed_btn.setStyle("-fx-background-color:transparent");
